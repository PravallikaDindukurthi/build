...
- Optional:
  ...
  - `spec.retention.ttlAfterFailed` - Specifies the duration that a failed buildrun should be allowed to exist.
  - `spec.retention.ttlAfterSucceeded` - Specifies the duration that a successful buildrun should be allowed to exist.
  - `spec.retention.failedLimit` - Specifies the number of failed buildrun that are allowed to exist.
  - `spec.retention.succeededLimit` - Specifies the number of successful buildrun that are allowed to exist.
...
A `Build` resource can specify how long a completed BuildRun can be allowed to exist. Instead of manually cleaning up old BuildRuns, retention parameters  provide an alternate method for cleaning up BuildRuns automatically.
...
- `retention.ttlAfterFailed` - Specifies the duration that a failed buildrun should be allowed to exist.
- `retention.ttlAfterSucceeded` - Specifies the duration that a successful buildrun should be allowed to exist.
